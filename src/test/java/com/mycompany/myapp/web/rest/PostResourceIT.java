...
class PostResourceIT {
    ...
    public static Post createEntity() {
        return new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).createdDate(DEFAULT_CREATED_DATE);
    }
    ...
    public static Post createUpdatedEntity() {
        return new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE);
    }
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).createdDate(UPDATED_CREATED_DATE);
