...
type CommentFormGroupContent = {
  ...
  postComment: FormControl<CommentFormRawValue['postComment']>;
  userComment: FormControl<CommentFormRawValue['userComment']>;
};
...
export class CommentFormService {
  createCommentFormGroup(comment: CommentFormGroupInput = { id: null }): CommentFormGroup {
    ...
    return new FormGroup<CommentFormGroupContent>({
      ...
      postComment: new FormControl(commentRawValue.postComment),
      userComment: new FormControl(commentRawValue.userComment),
    });
  }
