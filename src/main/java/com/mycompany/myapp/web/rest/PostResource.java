...
public class PostResource {
    ...
    public ResponseEntity<Post> updatePost(
        ...
        // Recuperar el post existente para validar autoría
        Post existingPost = postRepository.findById(id)
            .orElseThrow(() -> new BadRequestAlertException("Post not found", ENTITY_NAME, "idnotfound"));

        // Verificar que el usuario autenticado es el autor del post
        /*
        if (!existingPost.getUserPost().equals(user)) {
